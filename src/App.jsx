...
import AboutUs from "./pages/customer/pages/AboutUs";
import FAQs from "./pages/customer/pages/Faq's";
import PrivacyPolicy from "./pages/customer/pages/PrivacyPolicy";
import TermsAndConditions from "./pages/customer/pages/Terms&Conditions";
