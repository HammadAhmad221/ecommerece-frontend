                            ...
                            <>
                                <ProductContainer>
                                    ...
                                    <ProductInfo>
                                        ...
                                        <Description>{productDetails && productDetails.description}</Description>
                                        <ProductDetails>
                                            <DetailItem>Category: {productDetails && productDetails.category}</DetailItem>
                                            <DetailItem>Subcategory: {productDetails && productDetails.subcategory}</DetailItem>
                                        </ProductDetails>
                                    </ProductInfo>
                                </ProductContainer>
                                        ...
                                        {productDetails.reviews.map((review, index) => (
                                            <ReviewCard key={index}>
                                                <ReviewCardDivision>
                                                    ...
                                                    <ReviewDetails>
                                                        <Typography variant="h6" gutterBottom>{review.reviewer.name}</Typography>
