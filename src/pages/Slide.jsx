...
//             <div className="flex flex-shrink items-center justify-center gap-4 p-6 w-[90%]">
...
const Slide = ({ products, title }) => {
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="flex flex-wrap justify-center gap-10 py-6 w-[100%]">
        {products.map((product, index) => (
          <Link
            key={index}
            to={`/product/view/${product._id}`}
            className="no-underline w-full sm:w-1/2 md:w-1/3 lg:w-1/5"
          >
            <div className="text-center p-4 bg-gray-100 rounded-lg">
              <img
              ...
              />
              <h3 className="text-base font-semibold mt-2 text-gray-900 truncate">
                {product.productName}
              </h3>
              <div className="flex gap-2 justify-center items-center mt-2">
              ...
              <p className="text-sm text-gray-900 opacity-60 mt-2">
                {product.tagline}
              </p>
            </div>
          </Link>
