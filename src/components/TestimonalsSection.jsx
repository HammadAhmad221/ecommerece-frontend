...
//       text: "This is the best service I've ever used. Highly recommend it to everyone to try it.",
//       image: "/product1.png",
//       rating: 5,
//     },
//     {
...
const TestimonialsSection = () => {
  ...
  useEffect(() => {
    updateSlidesToShow(); // Initial call to set the correct slides
    window.addEventListener("resize", updateSlidesToShow); // Add resize event listener
    return () => {
      window.removeEventListener("resize", updateSlidesToShow); // Clean up listener
    };
  }, []);
